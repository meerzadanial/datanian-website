...
<html lang="en">
<head>
  <title>Agriculture - Datanian</title>
  <!-- Required meta tags -->
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
  @vite(['resources/css/agriculture.css', 'resources/js/agri.js'])
    ...
    <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src= "{{URL('images/agriculture.jpg')}}" class="d-block w-100 h-auto" alt="...">
            <div class="carousel-caption">
              
              <h2 class="banner-title">Agriculture</h2>
              <p class="banner-description">Complete agriculture monitoring solution, near real-time monitoring, training, and consultation.</p>
            </div>
          </div>

          <div class="carousel-item">
            <img src= "{{URL('images/agriculture 2.jpg')}}" class="d-block w-100 h-auto" alt="...">
            <div class="carousel-caption">
                <h2 class="banner-title">Agriculture</h2>
                <p class="banner-description">Complete agriculture monitoring solution, near real-time monitoring, training, and consultation.</p>
              </div>
          ...
          <div class="carousel-item">
            <img src= "{{URL('images/agriculture 3.jpg')}}" class="d-block w-100 h-auto" alt="...">
            <div class="carousel-caption">
                <h2 class="banner-title">Agriculture</h2>
                <p class="banner-description">Complete agriculture monitoring solution, near real-time monitoring, training, and consultation.</p>
              </div>
      ...
      <div class="section-background hidden" style="background-image: url('{{ URL('images/subtlebg.png') }}')">
        <div class="team-head">
            <div class="section-title hidden">
                 <!--Main Title-->   
            <h2 style="font-weight:bold; color:#595959; padding-bottom:70px; padding-top:70px;" align="center">Why Choose <font color="#0ce6aa">Data-Driven</font> Precision Farming?</h2>
            <div class="container">
              <div class="row justify-content-center">
             <!-- Data Driven Precision Farming Contents-->
                <div class="col-md-4">
                  <!-- Content goes here -->
                  <div class="card">
                    <div class="card-body">
                      <h5 class="card-title">Optimize Your Schedule</h5>
                      
                      <img src="{{URL('images/optimize schedule.jpg')}}" class="img-fluid" alt="Image">
                      <br>
            
                      <ul>
                        <br>
                        <li><p class="card-text">Determine key focus areas for harmonizing with the set targets</p></li>
                        <br>
                        <li><p class="card-text">Enhancing overall efficiency</p></li>
                        <br>
                        <li><p class="card-text">Increasing work output</p></li>
                      </ul>
                ...
                <div class="col-md-4">
                  ...
                  <div class="card">
                    <div class="card-body">
                      ...
                      <img src= "{{URL('images/cost effective.jpg')}}" class="img-fluid" alt="Image">
                      <br>
                      <ul>
                        <br>
                        <li><p class="card-text">Creating high-quality products affordably</p></li>
                        <br>
                        <li><p class="card-text">Strategically manage and budget expenditures</p></li>
                        <br>
                        <li><p class="card-text">Boost Price-Value Ratio</p></li>
                ...
                <div class="col-md-4">
                  ...
                  <div class="card">
                    <div class="card-body">
                      <h5 class="card-title">Streamline Workflow</h5>
                      <img src= "{{URL('images/workflow.jpg')}}" class="img-fluid" alt="Image">
                      <br>
            
                      <ul>
                        <br>
                        <li><p class="card-text">Simplify and automate repetitive business tasks</p></li>
                        <br>
                        <li><p class="card-text">Reduce errors and increase precision</p></li>
                        <br>
                        <li><p class="card-text">Increase overall efficiency</p></li>
                      </ul>
                    </div>
                  </div>
                </div>
...
<!-- Owl Carousel Display Products Contents-->
<section id="slider" class="pt-5">
  <div class="container">
    
    <h2 style="font-weight:bold; color:#595959; padding-bottom:40px;" class="product-head hidden" align="center">Our <font color="#0ce6aa">Products</font></h2>
    <div class="slider hidden">
      <div class="slidertree owl-carousel">
        ...
        <div class="slider-card">
          ...
          <h5 class="mb-0 text-center title">Power Resetter</h5>
        ...
        <div class="slider-card" >
          ...
          <h5 class="mb-0 text-center title">Smart Data Acquisition &
            &ZeroWidthSpace;
            <br>
             Logger (SDB)</h5>
