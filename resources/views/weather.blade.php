    ...
    <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="{{URL('images/weather 1.jpg')}}" class="d-flex w-100 h-20" alt="...">
            <div class="carousel-caption">
              <h2 class="banner-title">Weather</h2>
              <p class="banner-description">Complete weather monitoring solution, near real time monitoring, training and consultation.</p>
            </div>
          </div>

          <div class="carousel-item">
            <img src="{{URL('images/weather 2.jpg')}}" class="d-block w-100 h-auto" alt="...">
            <div class="carousel-caption">
                <h2 class="banner-title">Weather</h2>
                <p class="banner-description">Complete weather monitoring solution, near real time monitoring, training and consultation.</p>
              </div>
          ...
          <div class="carousel-item">
            <img src="{{URL('images/weather 3.jpg')}}" class="d-block w-100 h-auto" alt="...">
            <div class="carousel-caption">
                <h2 class="banner-title">Weather</h2>
                <p class="banner-description">Complete weather monitoring solution, near real time monitoring, training and consultation.</p>
              </div>
      ...
      <!-- Weather Contents-->
        ...
        <div class="head">
          <font color="#595959"><h5 class="head text-center text-md-left hidden" style="padding-bottom: 50px;">We have contributed our products to the <font color="#0ce6aa">weather-related</font> solution.</h5></font>
        </div>
                ...
                <div class="slidertree owl-carousel">
                  ...
                  <div class="slider-card">
                    <div class="d-flex justify-content-center align-items-center mb-4">
                      <img src="{{URL('images/aws 1.png')}}" alt="" class="img-fluid img-resize">
                    </div>
                    <h5 class="mb-0 text-center title" style="text-align:justify;">Automatic Weather 
                      &ZeroWidthSpace;
                      <br>
                      Station </h5>
                    <p class="p-4 desc" style="text-align:justify;">Datanian AWS stands at the forefront of professional-grade meteorological equipment, renowned worldwide for its exceptional quality and performance. Our meteorological sensors are engineered to provide unparalleled accuracy and reliability, making them the preferred choice for professionals in the field of meteorology</p>
                  </div>
          
                  <div class="slider-card">
                    <div class="d-flex justify-content-center align-items-center mb-4">
                      <img src="{{URL('images/paws.png')}}" alt="" class="img-fluid img-resize">
                    </div>
                    <h5 class="mb-0 text-center title" style="text-align:justify;">Portable Automatic 
                      &ZeroWidthSpace;
                      <br>
                      Weather Station</h5>
                    <p class="p-4 desc" style="text-align:justify;">Datanian PAWS collects and store rain data from field locations. This information is retrieved by the end user daily in real-time, allowing site control to adjust station run time and/or schedule day cycle frequency according to the parameters monitored</p>
                  </div>
          
                  <div class="slider-card">
                    <div class="d-flex justify-content-center align-items-center mb-4">
                      <img src="{{URL('images/prs.png')}}" alt="" class="img-fluid img-resize">
                    </div>
                    <h5 class="mb-0 text-center title" style="text-align:justify;">Portable Rain Station</h5>
                    <p class="p-4 desc" style="text-align:justify;">Datanian PRS offers unparalleled flexibility in weather parameter measurement, allowing you to deploy it at any location. This versatile device can be effortlessly installed, relocated, and uninstalled, making it ideal for temporary weather monitoring needs</p>
                  </div>
            ...
            <div class="container">
              ...
              <div class="slider">
                <div class="slidertree owl-carousel">
                  ...
                  <div class="slider-card">
                    <div class="d-flex justify-content-center align-items-center mb-4">
                      <img src="{{URL('images/lds.png')}}" alt="" class="img-fluid img-resize">
                    </div>
                    <h5 class="mb-0 text-center title" style="text-align:justify;">Lightning Detection 
                      &ZeroWidthSpace;
                      <br>
                      System</h5>
                    <p class="p-4 desc" style="text-align:justify;">The EFM-LDS-100 Electric Field Mill short-range sensor (<20 miles/32 km) constantly monitors for lightning and activates graphical display alerts on a computer or laptop when lightning is detected</p>
                  </div>

                  <div class="slider-card">
                    <div class="d-flex justify-content-center align-items-center mb-4">
                      <img src="{{URL('images/rain gauge.jpg')}}" alt="" class="img-fluid img-resize">
                    </div>
                    <h5 class="mb-0 text-center title">Rain Gauge</h5>
                    <p class="p-4 desc" style="text-align:justify;">The Datanian RG601SS is a state-of-the-art tipping bucket rain gauge meticulously crafted to exceed National Weather Service criteria, delivering precise and reliable precipitation data for meteorological and environmental applications</p>
                  </div>
